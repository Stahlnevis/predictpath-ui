...
const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    icon: GitBranch,
    command: ".\\Tool2\\.venv\\Scripts\\python.exe -m src.main",
    inputPath: "..\\Tool1\\output\\events.parquet",
    outputPath: "Tool2/risk_assessment.json",
    isAuto: false,
  },
  {
    id: 3,
    ...
    icon: Brain,
    command: ".\\Tool3\\.venv\\Scripts\\python.exe -m src.main",
    inputPath: "..\\Tool2\\risk_assessment.json",
  ...
  },
  {
    ...
    icon: Scale,
    command: ".\\Tool4\\.venv\\Scripts\\python.exe -m src.main",
  ...
  },
  {
    ...
    icon: Zap,
    command: ".\\Tool5\\.venv\\Scripts\\python.exe -m src.main",
  ...
  },
  {
    ...
    icon: GraduationCap,
    command: ".\\Tool6\\.venv\\Scripts\\python.exe -m src.main",
    inputPath: "..\\Tool5\\execution_report.json",
    outputPath: "Tool6/governance.db",
    isAuto: true,
  },
];
